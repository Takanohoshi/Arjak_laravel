...
class dataController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('petugas.datapetugas.index', compact('dataartikel'));
    }
    ...
    public function create()
    {
        ...
        $title = 'Create | Data';
        return view('petugas.datapetugas.create', compact('title', 'category'));
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('datapetugas.index')->with('success', 'Artikel berhasil ditambahkan');
    }
    ...
    public function edit(string $id)
    {
        ...
        $title = 'Edit | Data';
        return view('petugas.datapetugas.edit', compact(['dataartikel', 'title']));
    }
    ...
    public function update(Request $request, Dataartikel $dataartikel,string $id)
    {
            ...
            // Redirect ke halaman daftar artikel dengan pesan sukses
            return redirect()->route('datapetugas.index')->with('success', 'Artikel berhasil diperbarui');
    ...
    // Redirect ke halaman daftar artikel dengan pesan sukses
    return redirect()->route('datapetugas.index')->with('success', 'Artikel berhasil dihapus');
    }
}
